        ...
        <div className="flex justify-between items-center w-full">
          ...
          <Link href="/">
            <h1 className="text-2xl font-medium  text-neutral-300 flex items-center gap-2">
              {/* <GiShieldBash className="text-red-600 text-2xl" /> */}
              <Image
                src="/logo.svg"
                alt="BashForge Logo"
                width={30}
          ...
          {isLogged ? (
            <Link
              href="/dashboard"
              className="hidden lg:flex px-4 py-2 rounded-md text-md font-medium bg-red-600 hover:bg-red-600/70 transition-colors duration-200"
            >
              Profile
            </Link>
          ) : (
        ...
        {isMenuOpen && (
          <div className="flex flex-col justify-center items-center gap-4 w-full mt-5 pb-3">
            ...
            {isLogged ? (
              <Link
                href="/dashboard"
                className="w-full md:w-auto text-center px-4 py-2 rounded-md bg-red-600 hover:bg-red-600/70 text-md font-medium transition"
              >
                Profile
              </Link>
            ) : (
