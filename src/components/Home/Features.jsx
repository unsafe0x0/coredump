...
const data = [
  {
    ...
    icon: (
      <FaFire
        size={48}
        className="p-2.5 rounded-md bg-gradient-to-l from-orange-500 to-orange-700 text-white"
      />
    ),
  },
  {
    ...
    icon: (
      <MdLeaderboard
        size={48}
        className="p-2.5 rounded-md bg-gradient-to-l from-yellow-500 to-yellow-500 text-white"
      />
    ),
  },
  {
    ...
    icon: (
      <FaChartLine
        size={48}
        className="p-2.5 rounded-md bg-gradient-to-l from-blue-500 to-blue-500 text-white"
      />
    ),
  },
  {
    ...
    icon: (
      <FaCode
        size={48}
        className="p-2.5 rounded-md bg-gradient-to-l from-violet-500 to-violet-500 text-white"
      />
    ),
  },
  {
    ...
    icon: (
      <FaBullseye
        size={48}
        className="p-2.5 rounded-md bg-gradient-to-l from-red-500 to-red-500 text-white"
      />
    ),
  },
  {
    ...
    icon: (
      <FaMedal
        size={48}
        className="p-2.5 rounded-md bg-gradient-to-l from-orange-500 to-orange-500 text-white"
      />
    ),
  },
];
      ...
      <div className="flex flex-col justify-center items-center w-full gap-5 px-3 lg:container">
        ...
        <div className="columns-1 md:columns-2 lg:columns-3 gap-7 space-y-7 justify-start items-stretch w-full mt-10">
          {data.map((item) => (
            <div
              key={item.id}
              className="flex flex-col justify-start items-start w-full gap-2 p-7 rounded-md bg-neutral-800/70 backdrop-blur-2xl break-inside-avoid hover:shadow-lg transition-all duration-300 ease-in-out"
            >
              {item.icon}
