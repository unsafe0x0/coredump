...
import { Flame, Medal } from "@phosphor-icons/react";
...
const LeaderboardTable: React.FC<LeaderboardTableProps> = ({
  ...
  if (!leaderboardData || leaderboardData.length === 0) {
    return (
      <div className="flex justify-center items-center w-full bg-card border border-border p-8 rounded-xl">
        <Loader />
      </div>
    );
  }
  ...
  return (
    <div className="overflow-x-auto w-full rounded-xl border border-border bg-card custom-scrollbar">
                      ...
                      index === 0
                        ...
                        : index === 1
                          ...
                          : index === 2
                            ...
                            : "bg-card border-2 border-border text-foreground/80"
                    }`}
                  >
                    {index < 3 ? (
