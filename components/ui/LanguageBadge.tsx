...
const LanguageBadge: React.FC<LanguageBadgeProps> = ({
  ...
  return (
    <div className="relative z-50">
      ...
      {isHovered && (
        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 px-3 py-2 bg-black text-white text-sm rounded-md whitespace-nowrap z-[9999] shadow-xl border border-neutral-600">
          {lang}
