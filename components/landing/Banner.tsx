...
const Banner = () => {
  return (
    <section className="flex justify-center items-center w-full">
      <div className="flex flex-col items-center justify-center px-4 py-20 bg-card border border-border rounded-md max-w-5xl text-center mx-3 md:mx-0 gap-3 w-full">
