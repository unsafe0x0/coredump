...
const MockDashboard = () => {
  ...
  return (
    <div className="w-full max-w-7xl bg-card rounded-xl border border-border p-6">
      ...
      <div className="flex flex-col justify-start items-start w-full p-4 rounded-lg bg-background border border-border mb-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
        <div className="flex justify-start items-center bg-background border border-border rounded-lg p-3 gap-3">
          <span className="p-2 bg-accent-subtle rounded text-accent text-lg flex">
            <Flame />
          </span>
      ...
      <div className="flex flex-col justify-start items-start w-full p-4 rounded-lg bg-background border border-border">
        ...
        <div className="flex flex-wrap justify-start items-center w-full gap-2 mb-4">
          {mockLanguages.map((lang, _index) => {
            ...
            return (
              <div key={lang.name} className="relative z-50">
                <div
        ...
        <div className="w-full space-y-2">
          {mockLanguages.slice(0, 3).map((lang, _index) => {
            const languageKey =
