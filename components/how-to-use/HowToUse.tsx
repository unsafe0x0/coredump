"use client";
import { FaCode, FaDownload, FaKey, FaPlay, FaSync } from "react-icons/fa";
			...
			<div className="flex flex-col justify-start items-center w-full max-w-7xl px-3 gap-8 relative z-10">
				...
				<div className="grid gap-6 w-full max-w-4xl">
					{steps.map((step) => (
						<div
							key={step.number}
							className="flex justify-start items-center bg-card border border-border rounded-lg p-5 backdrop-blur-sm gap-5"
						>
							<span className="p-4 bg-linear-to-br from-accent to-accent/80 rounded-lg text-accent-text text-2xl flex">
								{step.icon}
							</span>
