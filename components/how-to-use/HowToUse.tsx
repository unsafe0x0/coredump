...
const HowToUse = () => {
  const steps = [
    {
      ...
      icon: <TerminalWindow className="text-2xl" />,
    },
    {
      number: 2,
      title:
    ...
    },
    {
      ...
      icon: <DownloadSimple className="text-2xl" />,
    },
    {
      number: 4,
    ...
    },
    {
      ...
      icon: <ArrowClockwise className="text-2xl" />,
    },
    {
      number: 9,
  ...
  return (
    <section className="flex justify-center items-start w-full min-h-screen py-20">
      <div className="flex flex-col justify-start items-center w-full max-w-7xl px-4 gap-8">
        ...
        <div className="grid gap-6 w-full max-w-4xl">
          {steps.map((step) => (
            <div
              key={step.number}
              className="flex justify-start items-center bg-card border border-border rounded-lg p-5 gap-5"
            >
              <span className="p-4 bg-accent-subtle rounded-lg text-accent text-2xl flex">
                {step.icon}
              </span>
