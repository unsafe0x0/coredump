...
const LanguageBadge: React.FC<LanguageBadgeProps> = ({
  ...
  return (
    <div className="relative z-50">
      <div
        className={`flex items-center justify-center gap-1 px-3 py-2 border rounded-lg text-sm font-semibold whitespace-nowrap min-w-[70px] h-9 ${color}`}
      ...
      {isHovered && (
        <div className="absolute -top-12 left-1/2 transform -translate-x-1/2 px-3 py-2 bg-card border border-border text-foreground text-sm rounded-lg whitespace-nowrap z-9999">
          {lang}
