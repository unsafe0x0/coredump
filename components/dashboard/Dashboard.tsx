...
import { Gear, HouseSimple } from "@phosphor-icons/react";
import {
...
const Dashboard = () => {
  ...
  return (
    <section className="flex justify-center items-start w-full min-h-screen py-12 bg-background">
      <div className="flex flex-col justify-start items-start max-w-7xl w-full px-4">
        ...
        <div className="flex flex-col justify-start items-start w-full py-5 rounded-lg bg-card border border-border mb-5">
